...
O back-end do projeto, que lida com a lógica e o armazenamento dos dados, está disponível neste repositório. Já o front-end, responsável pela interface do usuário, está disponível [aqui](https://github.com/richardcaetano/food-explorer-frontend).
...
O back-end do projeto está hospedado no endereço https://food-explorer-backend-nrw4.onrender.com. A aplicação Food Explorer está disponível para uso [aqui](https://food-explorer-ri.netlify.app/).
...
```
$ git clone https://github.com/richardcaetano/food-explorer-backend
```
